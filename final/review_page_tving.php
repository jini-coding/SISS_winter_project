...
<html>
  ...
  <body>
    ...
    <ul class="menu">
        <li><a href="review_page_tving.php" id="selected">- 리뷰 모아보기</a></li>
    </ul>
    ...
    <div id="board"><h3>Tving 리뷰 모아보기</h3>
      ...
      <thead>
        ...
        <?php
          ...
          $sql1 = mq("select * from review_list where ott='tving'");
          ...
          $total_page = ceil($total_record / $list);
            ...
            $sql = mq("select * from review_list where ott='tving' order by id desc limit $page_start, $list");
      ...
      <div id="page_num" style="text-align: center; padding-top:20px;">
			    	<?php
				    	if ($page <= 1){
				    		...
				    		echo "<a href='review_page_tving.php?page=1'>맨 처음</a>";
				    	}

				    	if ($page <= 1){
				    	} else {
				    		$pre = $page - 1;
				    		echo "<a href='review_page_tving.php?page=$pre'> ◀ </a>";
				    	...
				    	for($i = $block_start; $i <= $block_end; $i++){
				    		if($page == $i){
				    			...
				    			echo "<a href='review_page_tving.php?page=$i'> $i </a>";
				    		}
				    	}
				    	...
				    	if($page >= $total_page){
				    		...
				    		$next = $page + 1;
				    		echo "<a href='review_page_tving.php?page=$next'> ▶ </a>";
				    	}

				    	if($page >= $total_page){
				    	} else {
				    		echo "<a href='review_page_tving.php?page=$total_page'>맨 끝</a>";
				    	}
					?>
				</div>
